...
void function () {
  var async, axilla, cacheFunction, cachePartial, cacheTemplate, fs, glob, isAbsolutePath, isPartial, Mustache, partials, Path, readFile, readFileSync, removeBaseDir, render, stripPath, templates, utils;
  fs = require('fs');
  Path = require('path');
  glob = require('glob');
  async = require('async');
  ...
  cachePartial = function (path, template) {
    return partials[path] = template;
  };
