...
void function () {
  var async, axilla, buildRenderFunction, cacheContents, cachePartial, cacheTemplate, compileFromDiskAndRender, fs, glob, Handlebars, isAbsolutePath, isPartial, partials, Path, readFile, readFileSync, removeBaseDir, render, stripPath, templates, utils;
  fs = require('fs');
  Path = require('path');
  glob = require('glob');
  async = require('async');
